...
*/
#ifndef DIRECT3DMODELFACTORY_H_
#define DIRECT3DMODELFACTORY_H_
...
namespace simplicity
{
	namespace direct3d
	{
		/**
		* <p>
		* A factory that creates meshes implemented using Direct3D.
		* </p>
		*/
		class SIMPLE_API Direct3DModelFactory : public ModelFactory
		{
			public:
